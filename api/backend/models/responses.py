...
class SQLArtifact(BaseModel):
    ...
    # The query's own column order. Without it the client falls back to the key
    # order of the first row, which loses the SELECT order and leaves an empty
    # result with no headings at all.
