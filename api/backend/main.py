...
def create_app() -> FastAPI:
    ...
    app.include_router(org_admin.router, prefix="/api", tags=["organization"], dependencies=auth_dep)
    app.include_router(tickets.router, prefix="/api", tags=["tickets"], dependencies=auth_dep)
    app.include_router(commerce.router, prefix="/api", tags=["commerce"], dependencies=auth_dep)
    app.include_router(org_ops.router, prefix="/api", tags=["organization"], dependencies=auth_dep)
    ...
    app.include_router(
        admin_commerce.router, prefix="/api", tags=["admin"], dependencies=admin_dep,
    )
    app.include_router(
        admin_ops.router, prefix="/api", tags=["admin"], dependencies=admin_dep,
    )
