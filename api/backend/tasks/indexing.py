    ...
    try:
        ...
        if result.success:
            ...
            completion_details = {
                ...
                "search_status": "ready",
                "event_index_status": result.event_index_status,
                "event_version_id": result.event_version_id,
                "event_observation_count": 0,
                "event_cluster_count": 0,
                "event_index_version": "master-events-v1" if result.event_version_id else "",
                "event_partial_reasons": list(result.event_partial_reasons),
            }
            ...
            registry.set_event_index(
                file_id, search_status="ready", status=result.event_index_status,
                version="master-events-v1" if result.event_version_id else "",
                partial_reasons=list(result.event_partial_reasons),
            )
            if job_id:
