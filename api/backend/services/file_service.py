        ...
        try:
            ...
            for rec in registry.get_all(project_id=project_id):
                ...
                files.append({
                    ...
                    "rows": 0,
                    "status": rec.status,
                    "search_status": getattr(rec, "search_status", "ready") or "ready",
                    "event_index_status": getattr(rec, "event_index_status", "not_started") or "not_started",
                    "event_observation_count": getattr(rec, "event_observation_count", 0),
                    "event_cluster_count": getattr(rec, "event_cluster_count", 0),
                    "event_index_version": getattr(rec, "event_index_version", "") or "",
                    "event_partial_reasons": list(getattr(rec, "event_partial_reasons", []) or []),
                    "document_date": "",
                    "sender": "",
                    "recipient": "",
                    "subject": "",
